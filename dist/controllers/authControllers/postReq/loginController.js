...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const REFRESH_TOKEN = jsonwebtoken_1.default.sign({ userId: user._id, role: user.role, firstName: user.firstName, lastName: user.lastName }, process.env.REFRESH_TOKEN_SECRET, { expiresIn: "1d" });
