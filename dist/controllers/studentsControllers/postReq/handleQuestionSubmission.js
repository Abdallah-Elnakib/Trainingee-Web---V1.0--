...
exports.evaluateQuestionWithAI = evaluateQuestionWithAI;
exports.handleQuestionSubmission = handleQuestionSubmission;
 ...
 */
function evaluateQuestionWithAI(question, answer) {
 ...
 */
function handleQuestionSubmission(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            ...
            console.log('Student tracks:', (_a = student.tracks) === null || _a === void 0 ? void 0 : _a.map((t) => t.trackName));
            ...
            let studentTrack = student.tracks.find((t) => {
                if (!t || !t.trackName)
                    return false;
            ...
            console.log('Available tasks:', studentTrack.tasks.map((t) => t.taskName || 'unnamed'));
            // Buscar la tarea por nombre normalizado
            let studentTask = studentTrack.tasks.find((t) => {
                if (!t || !t.taskName)
                    return false;
            ...
            try {
                ...
                const result = yield evaluateQuestionWithAI(questionText, answer);
