...
export const getAllStudents = async (req: Request, res: Response) => {
    try {
        ...
        tracks.forEach((track, index) => {
            ...
            console.log(`    Students in track: ${trackObj.trackData?.length || 0}`);
        });
        ...
        for (const currentTrack of tracks) {
            ...
            for (const student of track.trackData) {
                ...
                if (!studentIds.includes(studentIdString)) {
                    ...
                    studentRecord.trackInfo = { ...studentRecord.trackInfo, trackId, trackName };
                }
            }
        ...
        const trackCountReport: Record<number, number> = {};
        finalStudents.forEach(student => {
