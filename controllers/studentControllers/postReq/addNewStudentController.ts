...
export const addNewStudent = async (req: Request, res: Response) : Promise<void> => {
    try {
        ...
        const parsedStudentData = addStudentSchema.safeParse({ Id: Student.ID, Name: Student.Name, Degrees: Student.Degrees, Additional: Student.Additional, BasicTotal: Student.BasicTotal, TotalDegrees: Student.TotalDegrees, Comments: Student.Comments });
